...
institutesRoutes.post(`/institute-branch/get-all-doctors`, instituteAllDoctors);

institutesRoutes.post(
  `/institute-branch-doctor/save`,
  instituteBranchDoctorSave
);
...
institutesRoutes.post(`/institutes-and-branch/get`, institutAndBranchesGet);
