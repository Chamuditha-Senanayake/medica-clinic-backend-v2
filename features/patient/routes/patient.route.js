...
router.post(
  ...
  [
    ...
    check("NIC").optional().isString(),
    check("Passport").optional().isString(),
    check("Mobile").optional().isString(),
    check("BedHeadTicketNumber").optional().isString(),
    check("ClinicId").optional().isString(),
    check("UniqueId").optional().isString(),
    check("Name").optional().isString(),
    check("DateOfBirth").optional().isString(),
    check("Address").optional().isString(),
    check("ParentId").optional().isInt(),
    check("Guid").optional().isString(),
