  ...
  async updateBasicProfileInfo(request, response, next) {
    ...
    try {
      ...
      var params = [
        ...
        {
          name: 'IsBasicProfileInfo',
          type: sql.Bit,
          value: IsBasicProfileInfo,
        },
      ...
      updateBasicProfileInfoResult =
        updateBasicProfileInfoResult.recordsets[0][0];
      ...
      updateBasicProfileInfoResult.AddressInfo =
        userAddressInfoResult.recordsets[0][0];
      ...
      if (PrimaryContact) {
        ...
        updateBasicProfileInfoResult.PrimaryContact =
          userContactInfoResult.recordsets[0][0];
      }
      ...
      if (SecondaryContact) {
        ...
        updateBasicProfileInfoResult.SecondaryContact =
          userContactInfoResult.recordsets[0][0];
      }
  ...
  async updatePersonalProfileInfo(request, response, next) {
    ...
    try {
      ...
      updatePersonalProfileInfoResult =
        updatePersonalProfileInfoResult.recordsets[0][0];
